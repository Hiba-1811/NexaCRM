...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tickets_status', function (Blueprint $table) {
            $table->integer('ticketstatus_id')->primary();
            $table->timestamp('ticketstatus_created')->nullable();
            $table->integer('ticketstatus_creatorid')->nullable();
            $table->timestamp('ticketstatus_updated')->nullable();
            $table->string('ticketstatus_title', 200);
            $table->integer('ticketstatus_position');
            $table->string('ticketstatus_color', 100)->default('default');
