...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('contract_templates', function (Blueprint $table) {
            $table->integer('contract_template_id')->primary();
            $table->timestamp('contract_template_created');
            $table->timestamp('contract_template_updated');
            $table->integer('contract_template_creatorid')->nullable();
            $table->string('contract_template_title', 250)->nullable();
            $table->string('contract_template_heading_color', 30)->nullable()->default('#7493a9');
